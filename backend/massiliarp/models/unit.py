...
class Unit(models.Model):
    ...
    recruitment_cost = models.DecimalField(_('Recruitment cost'), max_digits=5, decimal_places=3)
    upkeep_cost = models.DecimalField(_('Unit upkeep'), max_digits=6, decimal_places=4)
